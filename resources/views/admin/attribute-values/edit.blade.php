        ...
        <form method="POST" action="{{ route($route.'.update') }}" class="p-t-15" id="SettingsFrm" enctype="multipart/form-data" data-validate=true>
            ...
            <div class="row m-0">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="priority" id="priority" value="{{$obj->priority}}">
                </div>
            </div>               
            <div class="row bottom-btn m-0">
                <div class="col-md-12" align="right">
                    <button type="submit" id="webadmin-ajax-form-submit-btn" class="btn btn-primary">Submit</button>
                </div>
             </div>
        </form>               
</div>
