                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        @if($obj->id)
                                            <h4 class="page-title">Edit Top Rankers</h4>
                                        @else
                                            <h4 class="page-title">Create new Top Rankers</h4>
                                        @endif
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{route($route.'.index')}}">All </a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Top Rankers<</li>
                                        </ol>
                                    </div><!--end col-->
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body row">
                                                        @include('admin.top_rankers.sections')
                                                    </div>
                                                </div>
