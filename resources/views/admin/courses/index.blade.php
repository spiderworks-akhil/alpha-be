                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">@if($parent_data) Sub-coursess of {{$parent_data->name}} @else All coursess @endif</h4>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            @if($parent_data)
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index', [$parent_data->parent_id]) }}">{{$parent_data->name}}</a></li>
                                            @endif
                                            <li class="breadcrumb-item active">List coursess</li>
                                        </ol>
                                    </div><!--end col-->
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="nosort nosearch table-width-10">Sub coursess</th>
...
@section('footer')
    <script>
        var my_columns = [
            ...
            {data: 'sub-courses', name: 'sub-courses'},
        ...
        $(function(){
            $(document).on('click', '.delete_have_child', function(){
                $.alert('Sorry! You cannot delete this category, to delete it please delete all its sub coursess.');
            })
        })
    </script>
    @parent
