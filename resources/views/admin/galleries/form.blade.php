                                                    ...
                                                    <div class="row add-multiple-image">
                                                        ...
                                                        <div class="col-md-4 mb-2" id="add-new-image-wrap">
                                                            ...
                                                            <div style="display:none" id="image-clone-holder">
                                                                @include('admin.media.set_file', ['file'=>null, 'title'=>'Event Media', 'popup_type'=>'single_image', 'type'=>'Image', 'holder_attr'=>'event_medias[]', 'id'=>'id_holder'])
                                                            </div>
                                                            <div style="display:none" id="video-clone-holder">
                                                                @include('admin.media.set_file', ['file'=>null, 'title'=>'Event Media', 'popup_type'=>'single_image', 'type'=>'Video', 'holder_attr'=>'event_medias[]', 'id'=>'id_holder'])
                                                            </div>
